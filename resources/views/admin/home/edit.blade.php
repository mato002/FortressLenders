...
@section('header-description', 'Control the hero background image for the public Home page.')
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <p class="text-sm text-gray-600">
                Upload an image that will appear behind the main hero section on the public home page.
                A wide image works best (e.g. 1600×700).
            </p>
                ...
                <div>
                    ...
                    @if ($settings->hero_image_path)
                        <div class="rounded-xl overflow-hidden border border-gray-100 bg-gray-50">
                            <img src="{{ asset('storage/'.$settings->hero_image_path) }}" alt="Home hero background" class="w-full h-48 object-cover">
                        </div>
                    @else
                        <p class="text-sm text-gray-500">No custom image set yet. The default animated teal gradient will be used.</p>
                    @endif
                </div>
