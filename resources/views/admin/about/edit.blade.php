...
@section('header-description', 'Control the hero background image for the public About page.')

@section('header-actions')
    <a href="{{ route('about') }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-teal-800 bg-teal-50 hover:bg-teal-100 border border-teal-100">
        Preview About Page
    </a>
@endsection
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            ...
            <p class="text-sm text-gray-600">
                Upload an image that will appear behind the “About Fortress Lenders” hero section on the public website.
                ...
                <div>
                    ...
                    @if ($settings->hero_image_path)
                        <div class="rounded-xl overflow-hidden border border-gray-100 bg-gray-50">
                            <img src="{{ asset('storage/'.$settings->hero_image_path) }}" alt="About hero background" class="w-full h-48 object-cover">
                        </div>
                    @else
